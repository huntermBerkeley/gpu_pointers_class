...
namespace tables {
   ...
   struct p2_bucket_lock {
      ...
      static const uint64_t n_pairs = bucket_size-1;
   ...
   __global__ void init_p2_int_table_kernel(table * hash_table){
   ...
   struct p2_int_table {
      ...
      using bucket_type = p2_bucket_lock<Key, defaultKey, tombstoneKey, Val, defaultVal, tombstoneVal, partition_size, bucket_size>;
